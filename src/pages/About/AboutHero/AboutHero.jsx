...
import '../AboutHero/AboutHero.Module.css'

const AboutHero = () => {
  return (
    <section className='w-full'>
      <div className='aboutHero text-center text-[#ffffff] py-[4rem]'>
        <h1 className='text-[50px]'>About Us</h1>
        <p className='text-[24px] '>Explore a menu brimming with premium cuts and tantalizing <br /> flavors, expertly crafted to delight even the most discerning <br /> palates.</p>
      </div>
      <div className='md:px-[5rem] px-[2rem] '>
