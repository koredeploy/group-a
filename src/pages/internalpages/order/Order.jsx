        ...
        <div className="border border-white rounded-md font-semibold text-[#0C513F] bg-white  px-5 py-3">
          <div className="w-[30rem] py-2 relative">
            <input
              ...
              className="font-normal text-[15.28px] border-[1.5px] sm:w-full py-3 px-10 outline-none border-[#191B1D] rounded-md"
            />
            <CiSearch className="absolute px-2 top-0 my-3" fontSize={40} />
          </div>

          <div className="sm:w-full bg-[#FF7834] text-white py-3 rounded-md mt-5 flex">
            <h2 className="sm:px-4 text-[18.25px]">ID</h2>
            <div className="sm:px-[4rem] flex items-center gap-2">
              <img src={open} alt="" />
              <h3>Menu</h3>
            </div>
            <div className="sm:px-[3.5rem] flex items-center gap-2">
              <img src={open} alt="" />
              <h3>Date</h3>
            </div>
            <div className="sm:px-[2rem] flex items-center gap-2">
              <img src={open} alt="" />
              <h3>Amount</h3>
            </div>
            <div className="sm:px-[7.5em] flex items-center gap-2">
              <img src={open} alt="" />
              <h3>Status</h3>
            </div>
            <h4>Action</h4>
          ...
          <div className="mt-5  flex items-center font-medium gap-[2rem] text-[#191B1D] ">
            ...
            <h2 className="text-[11.93px] ">
              Chicken curry special with <br className="" /> cucumber
            </h2>
