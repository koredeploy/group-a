...
const Hero = () => {
    ...
    return (
        <div className='w-full bg-[#073126] text-white flex justify-center items-center px-[7rem] gap-[1rem]'>

            <div className='grid gap-[1rem] justify-center items-center leading-[2rem] w-full'>
                <h1 className='text-[60px] font-bold'>MEAL TIME</h1>
                <h2 className='text-[35px] font-extralight'>FUEL YOUR STUDY</h2>
            ...
            <div className='w-full grid gap-[1rem] justify-center items-center'>
                <div className='text-black relative'>
                    <div className='justify-center items-center flex border hover:border-[#FF7834] rounded-full bg-white px-[.2rem] pr-[5rem] py-[.2rem]' onMouseEnter={() => handleMouseEnter(egusiHover)} onMouseLeave={handleMouseLeave}>
                        <div>
                ...
                <div className='text-black relative'>
                    <div className='justify-center items-center flex border hover:border-[#FF7834] rounded-full bg-white px-[.2rem] pl-[4rem] py-[.2rem]' onMouseEnter={() => handleMouseEnter(riceHover)} onMouseLeave={handleMouseLeave}>
                        <div className=''>
                ...
                <div className='text-black relative'>
                    <div className='justify-center items-center flex border hover:border-[#FF7834] rounded-full bg-white px-[.2rem] pr-[5.5rem] py-[.2rem] ' onMouseEnter={() => handleMouseEnter(chopsHover)} onMouseLeave={handleMouseLeave}>
                        <div>
