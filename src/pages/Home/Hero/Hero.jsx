    ...
    return (
        <div className='w-full bg-[#073126] text-white md:flex md:flex-row flex flex-col-reverse justify-center items-center md:px-[7rem] px-[3rem] gap-[1rem]'>
            ...
            <div className='w-full border bg-white rounded-full px-[1rem] py-[1rem] my-[3rem] grid justify-center'>
                <img src={hoveredItem || defaultImage} alt="Default" className='w-full h-full object-cover'/>
            </div>
            ...
            <div className='w-full md:grid gap-[1rem] justify-center items-center hidden'>
                <div className='text-black relative'>
                    ...
                    >
                        <div className='w-[5rem] h-[5rem]'>
                            <img src={egusiImage} alt="Egusi" className='w-full h-full object-cover' />
                        </div>
                        <div className='ml-4'>
                            <h1>Eba & Egusi</h1>
                ...
                <div className='text-black relative'>
                    ...
                    >
                        ...
                        <div className='w-[5rem] h-[5rem]'>
                            <img src={friedImage} alt="Fried Rice" className='w-full h-full object-cover' />
                        </div>
                    </div>
                </div>
                <div className='text-black relative'>
                    ...
                    >
                        <div className='w-[5rem] h-[5rem]'>
                            <img src={chopsImage} alt="Small Chops" className='w-full h-full object-cover' />
                        </div>
                        <div className='ml-4'>
                            <h1>Small Chops</h1>
